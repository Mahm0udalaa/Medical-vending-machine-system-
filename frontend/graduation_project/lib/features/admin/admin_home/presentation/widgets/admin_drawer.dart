...
import 'package:graduation_project/features/admin/invoices/presentation/screens/admin_machines_invoices_home_view.dart';
import 'package:graduation_project/features/admin/profile/presentation/screens/admin_profile_screen.dart';
                ...
                itemBuilder: (context, index) {
                  return Padding(
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        if (items[index].title == 'Invoices') {
                          Navigator.of(context).pop();
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (_) => const AdminMachinesInvoicesHomeView(),
                            ),
                          );
                        } else if (items[index].title == 'Home') {
                          Navigator.of(context).pop();
                        } else if (items[index].title == 'Profile') {
                          Navigator.of(context).pop();
                          Navigator.of(context).push(
                            MaterialPageRoute(
